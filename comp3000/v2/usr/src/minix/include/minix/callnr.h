...
#define PM_KIRILL_TIME		(PM_BASE + 48)
#define PM_KIRILL_GETDPIDS	(PM_BASE + 49)
...
#define VFS_MYENCRYPT		(VFS_BASE + 64) /* project */

#define NR_VFS_CALLS		65	/* highest number from base plus one */
